...
team_data_file="team"+teamname+".txt"

# Check if the team file exists
try:
    # Open the team file
    f=open(team_data_file, 'r')
    ...
    if team_key == team_data[14]:
        team_data.pop(14)
        # team1.txt contains the details of the team playing against the computer
        # Copy all contents except the password from the original team file to this file.
        ...
        # This password is currently stored in plaintext. In a future release, passwords will be hashed and then stored.
