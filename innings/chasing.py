...
# opponent_netscore : Target - 1, the overall score of the opponent, including in Test Cricket.
...
def chasingInnings(team_1_array, team_2_array, innings, bat_bowl_choice, opponent_netscore, batting_score, innings_data, start_message, max_overs, max_wickets, is_test):
    ...
    # Batter statistics
    batter_stats={B1:[0,0,0,0], B2:[0,0,0,0], B3:[0,0,0,0], B4:[0,0,0,0], B5:[0,0,0,0], B6:[0,0,0,0], B7:[0,0,0,0], B8:[0,0,0,0], B9:[0,0,0,0], B10:[0,0,0,0], B11:[0,0,0,0]}
    # Bowler statistics    
    bowler_stats={A1:[0,0,0,0], A2:[0,0,0,0], A3:[0,0,0,0], A4:[0,0,0,0], A5:[0,0,0,0], A6:[0,0,0,0], A7:[0,0,0,0], A8:[0,0,0,0], A9:[0,0,0,0], A10:[0,0,0,0], A11:[0,0,0,0],}
